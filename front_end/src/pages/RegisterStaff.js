...
import RegisterStaffUserForm from "../components/RegisterStaffUserForm";
        ...
        <div>
            ...
            <Stack height={"170vh"} justifyContent={"center"}>
                <Typography component="h1" variant="h4" color={green[800]}>
                    Register Center Staff
                </Typography>
                <RegisterStaffUserForm  userRole={user.groups === undefined ? "" : user.groups[0]} />
            </Stack>
        </div>
    );
}
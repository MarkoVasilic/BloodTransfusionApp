    ...
    return (
        <div>
            <form onSubmit={handleSubmit(onSubmit)} >
                <Grid container rowSpacing={2} sx={{ padding: "55px 550px 0px 550px", textAlign: "left" }}>
                <Grid item xs={12}>
                        <Grid item>
                            <RadioButtonField name="less_than_50kg" control={control} label="Do you have less than 50kg?" rules={{ required: 'This field is required' }} />
                        </Grid>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid item>
                    ...
                    <Grid item xs={12}>
                        <Grid item>
                            <RadioButtonField name="tattoo_piercing_in_last_6_months" control={control} label="Tattoo or piercing in last 6 months?" rules={{ required: 'This field is required' }} />
                        </Grid>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid item>
                            <RadioButtonField name="surgery_in_last_6_months" control={control} label="Surgery in last 6 months?" rules={{ required: 'This field is required' }} />
                        </Grid>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid item>
                            <RadioButtonField name="blood_tranfusion_in_last_6_months" control={control} label="Blood transfusion in last 6 months?" rules={{ required: 'This field is required' }} />
                        </Grid>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid item>
                            <RadioButtonField name="pregnant" control={control} label="Are you pregnant?" rules={{ required: 'This field is required' }} />
                        </Grid>
                    </Grid>
                    <Grid item xs={12}>
                        <Button type="submit" variant="contained" sx={{ background: "#6fbf73", marginTop: 2, marginBottom: 5 }} fullWidth>
                            Submit
                        </Button>
                    </Grid>
                </Grid>
